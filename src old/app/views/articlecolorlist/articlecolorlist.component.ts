...
@Component({
  selector: 'app-articlecolorlist',
  templateUrl: './articlecolorlist.component.html',
  styleUrls: ['./articlecolorlist.component.scss']
})
export class ArticlecolorlistComponent implements OnInit {
  ...
  constructor(private userService: UserService, public router: Router, private toastr: ToastrService, private spinner: NgxSpinnerService,private http: HttpClient ,private titleService: Title) {
    this.titleService.setTitle("Article Color List | Colorhunt");
  }
      ...
      this.dtOptions = {
        ...
        ajax: (dataTablesParameters: any, callback) => {
          that.http.post<DataTablesResponse>(
              this.ApiURL+"/colorpostlist",
              dataTablesParameters, {}
            ).subscribe(resp => {
              that.colorlist = resp.data;
