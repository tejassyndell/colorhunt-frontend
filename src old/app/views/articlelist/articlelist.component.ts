...
export class ArticlelistComponent implements OnInit {
  ...
  constructor(private userService: UserService, public router: Router, private toastr: ToastrService, private spinner: NgxSpinnerService,private http: HttpClient ,private titleService: Title) {
    this.titleService.setTitle("Article List | Colorhunt");
  }
  ...
  public getArticleList() {
    const that = this;
      this.dtOptions = {
        ...
        columns: [{ data: 'No' }, { data: 'ArticleNumber' }, { data: 'CategoryName' }, { data: 'SubCategory' }, { data: 'Series' }, { data: 'Action' }]
      };
  }
  ...
  public delete(id) {
    ...
    Swal.fire({
      ...
      if (result.value == true) {
        this.userService.deletearticle(id , item[0].Id).subscribe((res) => {
  ...
  public viewlogs(id) {
    ...
    this.userService.articlelogs(id).subscribe((res) => {
