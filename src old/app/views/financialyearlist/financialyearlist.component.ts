...
@Component({
  selector: 'app-financialyearlist',
  templateUrl: './financialyearlist.component.html',
  styleUrls: ['./financialyearlist.component.scss']
})
export class FinancialyearlistComponent implements OnInit {
  public financialylist: any = [];
  ...
  constructor(private userService: UserService, public router: Router,private toastr: ToastrService,private spinner: NgxSpinnerService,private titleService: Title) {
    this.titleService.setTitle("Financial Year List | Colorhunt");
  }
  ...
  public delete(id) {
    Swal.fire({
      ...
      if (result.value == true) {
        this.userService.deletefinancialyear(id).subscribe((res) => {
          this.getfinancialyear();
          this.success(res);
  ...
  public edit(id) {
    this.router.navigate(['financial', { id: id }])
  }
