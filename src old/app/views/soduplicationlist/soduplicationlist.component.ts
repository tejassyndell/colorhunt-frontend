...
@Component({
  selector: 'app-soduplicationlist',
  templateUrl: './soduplicationlist.component.html',
  styleUrls: ['./soduplicationlist.component.scss']
})
export class SoduplicationlistComponent implements OnInit {
  public soduplist: any = [];
  ...
  constructor(private userService: UserService, public router: Router, private toastr: ToastrService, private spinner: NgxSpinnerService, private titleService: Title) {
    this.titleService.setTitle("SO Duplication List | Colorhunt");
  }
      ...
      if (typeof this.dtElement !== 'undefined' && typeof this.dtElement.dtInstance !== 'undefined') {
        this.dtElement.dtInstance.then((dtInstance: DataTables.Api) => {
          ...
          if (data['status'] == 'success') {
            this.soduplist = data['soDuplication'];
          }
          else {
            this.soduplist = [];
          }
  ...
  deletesoduplication(sonumberid, articleid) {
    ...
    Swal.fire({
      ...
      if (result.value == true) {
        this.userService.deletesoduplication(sonumberid, articleid).subscribe((res) => {
