...
@Component({
  selector: 'app-approvearticlelist',
  templateUrl: './approvearticlelist.component.html',
  styleUrls: ['./approvearticlelist.component.scss']
})
export class ApprovearticlelistComponent implements OnInit {
  ApiURL: string = environment.apiURL;
  public colorlist: Person[];
  public approvalarticle: any = [];
  ...
  showApproveArticleLogs: boolean = false;
  ...
  public getColor() {
    this.userService.approvalproductlist().subscribe((res) => {
      const data = res;
  ...
  public viewlogs(id) {
    this.showApproveArticleLogs = true;
    this.userService.approvearticlelogs(id).subscribe((res) => {
      this.ApproveArticleLogsData = res;
    });
  }
  CloseLogs() {
    this.showApproveArticleLogs = false;
  }
  success(data) {
    if (data.id != "") {
